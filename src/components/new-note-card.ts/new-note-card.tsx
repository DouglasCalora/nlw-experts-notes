import {
  NewNoteCardContentProps,
  NewNoteCardDefaultButtonProps,
  NewNoteCardProps,
  NewNoteCardRecordingButtonProps,
  NewNoteCardTextareaProps
...
// start internal componentes --------------------------------------------------
function Content (props: NewNoteCardContentProps) {
  return (
...
function Textarea (props: NewNoteCardTextareaProps) {
  return (
      <textarea
...
function RecordingButton (props: NewNoteCardRecordingButtonProps) {
  return (
      <button
...
function DefaultButton (props: NewNoteCardDefaultButtonProps) {
  return (
      <button
